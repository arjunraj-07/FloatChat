    ...
    <div className="fc-shell p-8 max-w-3xl mx-auto">
      <div className="fc-screenhead mb-8">
        <div className="fc-screenhead-main">
          ...
          <h1 className="fc-screen-title">Terms of Service</h1>
        </div>
      </div>
      <div className="fc-panel p-6 prose prose-invert">
        <p>This is a placeholder for the FloatChat terms of service.</p>
        <p>FloatChat is an educational and scientific exploration tool.</p>
      </div>
    </div>
  );
}
